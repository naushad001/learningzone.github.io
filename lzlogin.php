<?php
    $R="";
    $C=mysqli_connect("127.0.0.1","root","","Learningzone");
    if(isset($_POST["b1"]))
    
    {
        $s1=$_POST["t1"];
        $s2=$_POST["t2"];
        $result=$C->query("select * from login login where Email='$s1' AND Password='$s2'");
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#">B.SC(CS)</a>
          <a class="dropdown-item" href="#">MBA</a>
          <a class="dropdown-item" href="#">MCA</a>
          <a class="dropdown-item" href="#">M.SC(CS)</a>
      </li>
      <li class="nav-item">
        <a class="nav-link disabled" href="#">Contact</a>
      </li>
    </ul>
      <button class="btn btn-outline-success my-2 btn my-sm-0" type="submit"><span><img src="images/user.png">SIGN UP</span></button>
  </div>
</nav>
 </div>
</section>
	...
	<div class="row">
		<div class="col-sm-4 offset-4 divup ">
			<div height="40px" width="100px" class="divdown"><br>
				<h2 class="text-center text-dark font-weight-bold">LOG IN</h2>
				<div class="container text-center">
					<form >
						<input type="text" type="email" name="t1"  class=" form-control text" placeholder="Email Address"  required><br>
						<input type="password" type="password" name="t2" class=" form-control text " placeholder="Password"  required><br>
						<input type="Submit" Name='b1' value="LOG IN"><br><br>
               <p>Don't Have an Account? <a href="Lzlogin.php">Sign Up</a></p>
					</form>
